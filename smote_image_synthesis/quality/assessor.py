...
class QualityAssessor:
    ...
    def compute_diversity_metrics(self, synthetic_images: torch.Tensor) -> Dict[str, float]:
        ...
        # Use PyTorch directly to avoid CPU transfer and compute distances faster
        ...
        # using device=flattened.device prevents CPU-GPU synchronization overhead
        ...
        if len(upper_triangle) > 0:
            ...
            # Use unbiased=False to match np.std's default behavior
