...
class QualityAssessor:
    ...
    def compute_diversity_metrics(self, synthetic_images: torch.Tensor) -> Dict[str, float]:
        ...
        # Compute pairwise distances efficiently using PyTorch to avoid CPU/NumPy transfers (~3x speedup)
        # Using native torch.cdist computes distances directly on the device
        ...
        if len(upper_triangle) > 0:
            ...
            # unbiased=False matches numpy's np.std default
